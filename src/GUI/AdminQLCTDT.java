 ...
 * @author Admin
 */
public class AdminQLCTDT extends javax.swing.JFrame {

    /**
     * Creates new form QLHP
     */
    QLHP subjectApp = new QLHP();
    ArrayList<Subject> CTDT = new ArrayList<Subject>();
    ...
    private void btnAddSubjectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddSubjectActionPerformed
        if (subjectApp.searchSubjectCTDTByID(textMaHP.getText(), selectSchoolCTDT.getSelectedItem().toString(), selectTypeEdu.getSelectedItem().toString()) == -1) {
            //display in table
            ...
            tableModel.addRow(new Object[]{
                ...
                textHPTQ.getText(), selectKiHoc.getSelectedItem().toString(), selectTypeEduDetail.getSelectedItem().toString()
            });
            //add to arrayList
            ...
            subject.setTypeOfEdu(selectTypeEduDetail.getSelectedItem().toString());
            CTDT.add(subject);
            subjectApp.saveCTDT(CTDT, selectSchoolCTDT.getSelectedItem().toString());
    ...
    private void btnEditSubjectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditSubjectActionPerformed
        ...
        try {
            ...
            tableModel.setValueAt(selectTypeEduDetail.getSelectedItem().toString(), index, 6);
            //edit data in file
            CTDT.get(index).setIdSubject(textMaHP.getText());
            CTDT.get(index).setNameSubject(textTenHP.getText());
            CTDT.get(index).setSchoolSubject(selectSchool.getSelectedItem().toString());
            CTDT.get(index).setSoTC(selectSoTC.getSelectedItem().toString());
            CTDT.get(index).setPreSubject(textHPTQ.getText());
            CTDT.get(index).setSemester(selectKiHoc.getSelectedItem().toString());
            CTDT.get(index).setTypeOfEdu(selectTypeEduDetail.getSelectedItem().toString());
            subjectApp.saveCTDT(CTDT, selectSchoolCTDT.getSelectedItem().toString());
    ...
    private void btnDeleteSubjectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteSubjectActionPerformed
        ...
        if (index >= 0) {
            ...
            for (int i = 0; i < CTDT.size(); i++) {
                if (CTDT.get(i).getIdSubject().equalsIgnoreCase(idDel)) {
                    CTDT.remove(i);
                    subjectApp.saveFileHP(CTDT);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminQLCTDT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminQLCTDT().setVisible(true);
            }
        });
    }
